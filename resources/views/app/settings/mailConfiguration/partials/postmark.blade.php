<p class="alert alert-info text-sm">
    ...
    <code class="markup-code">{{ url(action(\Spatie\MailcoachPostmarkFeedback\PostmarkWebhookController::class)) }}</code>. You should set a header `mailcoach-signature` with the signing secret you specify in the form below.
</p>
